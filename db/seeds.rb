...
# p1 = Template.create(difficulty: 2, module: "PVT", question: "Un tanque rígido de {{volumen_tanque}} m3 contiene vapor a {{temperatura_vapor}} °C. Una tercera parte del volumen se encuentra en su fase líquida y el resto en forma de vapor. Determine el volumen del vapor y la calidad de la mezcla saturada.")

# ge = Template.generate_question(p1.question)

numerical_test = NumericalQuestion.create(difficulty: 1, question: "Un recipiente rígido contiene {{masa_kg}} kg de agua líquida saturada a {{temperatura_C_vap}}°C. Puesto que en el recipiente existen condiciones de saturación, la presión debe ser la presión de saturación a {{temperatura_C_vap}}°C, se muestra en la imagen: {{presion_saturacion}} kPa. Determine el volumen del recipiente.", 
answer: "si", hint: "holax2", domain: "quesesto", alter_domain: false)
